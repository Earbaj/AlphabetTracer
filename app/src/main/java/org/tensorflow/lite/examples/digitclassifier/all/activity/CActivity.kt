...
import org.tensorflow.lite.examples.digitclassifier.MainActivity
...
class CActivity : AppCompatActivity() {
    ...
    var num: Int = 0
    var color_string = "#FB8C00"
    //var predictedTextView: TextView? = null
    private val TAG = "MainActivity"
    private var resultB: String = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView?.setImageResource(R.drawable.newc)
        gifImageView?.setImageResource(R.drawable.ctrace)
        ...
        if ((bitmap != null) && (digitClassifier.isInitialized)) {
            digitClassifier
                ...
                .addOnSuccessListener {
                        resultText -> resultB = resultText
                    //predictedTextView?.text = resultB
                    if(resultB == "C"){
                        visibleApperance()
                        mediaPlayer?.start()
