...
import org.tensorflow.lite.examples.digitclassifier.all.activity.*
...
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    imageView?.setImageResource(R.drawable.newa)
    gifImageView?.setImageResource(R.drawable.atrace)
